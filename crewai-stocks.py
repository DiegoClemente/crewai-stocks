...
yahoo_finance_tool = Tool(
    ...
    description = "Fetch stock prices for 'ticket' from the last year",
...
stockPriceAnalyst = Agent(
    ...
    backstory="""
        You're highly experienced in analyzing the price of an specific stock and make predictions about its future price.""",
    verbose=True,
    llm=llm,
    max_iter=2,
    memory=True,
...
stockAnalystWriter = Agent(
    ...
    goal="Analyse the trends price and news and write an insightful compelling and informative 3 paragraph long newsletter based on the stock report and price trend",
    backstory="""
        You're widely accepted as the best stock analyst in the market. You understand complex concepts and create compelling stories and narratives
        that resonate with wider audiences.
        You understand macro factors and combine multiple theories - eg. cicle theory and fundamental analyses.
...
writeAnalyses = Task(
    ...
    expected_output="""
        ...
        - main part provides the meat of the analyses including the news summary and fear/greed scores.
